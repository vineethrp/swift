...
class LFSStatus(Thread):
    ...
    healthy. If check_func returns non-zero, it temporarly stops checking
    until the fault is cleared.

    interval        :   interval in seconds for checking FS
    check_func      :   method for checking FS. Takes exactly one argument
                        which should be a tuple. Returns 0 if FS is healthy
    check_args      :   tuple argument to check_func
    """
